...
//  Test
//
//  Created by Alexander Batyshev on 07.12.2022.
//
...
extension LogInViewController {
    ...
    @objc func keyboardWillShow(_ notification: NSNotification) {
        ...
        self.scrollView.contentInset = UIEdgeInsets(top: 0, left: 0, bottom: keyboardShow.height - self.view.safeAreaInsets.bottom + 20, right: 0)
    }
