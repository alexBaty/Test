...
class ProfileHeaderView: UIView {
    ...
    let statusLabel: UILabel = {
        var statusLabel = UILabel(frame: CGRect(x: 170, y: 150, width: 200, height: 20))
    ...
    let setStatusButton: UIButton = {
        var setStatusButton = UIButton(frame: CGRect(x: 0, y: 0, width: 10, height: 50))
    ...
    let avatarImageView: UIImageView = {
        var avatarImageView = UIImageView(frame: CGRect(x: 0, y: 0, width: 130, height: 130))
